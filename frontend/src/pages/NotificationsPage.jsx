  ...
  const renderRelatedPost = (relatedPost) => {
    ...
    return (
      <Link
        ...
        className="mt-2 p-2 bg-gray-50 rounded-lg flex items-center gap-2 hover:bg-gray-100 transition-colors"
      >
        {relatedPost.image && (
          <img
            ...
            <ul>
              {notifications.map((notification) => (
                <li
                  ...
                  className={`bg-white border rounded-lg p-4 my-4 transition-shadow hover:shadow-lg ${
